...
@section('content')
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Deseja realmente excluir o cliente <b><span class="user-nome"></span></b> e todo o seu conte&uacute;do?</p>
                </div>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header col-lg-9">Clientes</h1>
                <a href="{{ route('cli.create') }}" class="btn btn-primary col-lg-3" style="margin-top: 20px;">Novo</a>
            </div>
        </div><!--/.row-->
                        ...
                        <div class="container">
                            ...
                            <table class="table table-responsive  table-striped table-hover" >
                                ...
                                <tr>
                                    ...
                                    <th data-field="name"  data-sortable="true">CRACH&Aacute;</th>
                                    <th data-field="name"  data-sortable="true">EMPRESA</th>
                                ...
                                @foreach( $cliente as $clientes )
                                    <tr>
                                        <td> {{ $clientes->id }} </td>
                                        <td> {{ $clientes->nm_cliente }} </td>
                                        <td> {{ $clientes->nr_cracha }} </td>
                                        <td> {{ $clientes->empresas->ds_empresa }} </td>
                                        <td>

                                            <a href="#" class="btn-remove"  data-nome="{{ $clientes->nm_cliente }}" data-id="{{ $clientes->id }}"><i class="glyphicon glyphicon-remove"></i></a>
                                            <a href="#" class="btn-edit"  data-nome="{{ $clientes->nm_cliente }}" data-id="{{ $clientes->id }}"><i class="glyphicon glyphicon-edit"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
    ...
    <script>
        ...
        $('.btn-edit').on('click', function () {
            var id = $(this).data('id');
            var form = $('<form action="{{ route( 'cli.edit' ) }}" method="post">'+
