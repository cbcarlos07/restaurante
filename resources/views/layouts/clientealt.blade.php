            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        @endif
                        <form action="{{ route('cli.update') }}" method="post">
                                <input id="token" type="hidden" value="{{ csrf_token() }}" name="_token"/>
                                <input id="id" type="hidden" value="{{ $cliente->id }}" name="id"/>
                                <input id="senha" type="hidden" value="12345678" name="senha"/>
                                <input id="senha1" type="hidden" value="1234578" name="senha1"/>
                                <div class="form-group col-lg-7 {{ $errors->has('nome') ? ' has-error' : '' }}">
                                    <label for="nome">Nome</label>
                                    <input id="nome" class="form-control" name="nome" required value="{{ $cliente->nm_cliente }}" />
                                    @if ($errors->has('nome'))
                                ...
                                <div class="form-group col-lg-2 {{ $errors->has('cracha') ? ' has-error' : '' }}">
                                    ...
                                    <input id="cracha" class="form-control" name="cracha" required value="{{ $cliente->nr_cracha }}"/>
                                ...
                                <div class="form-group col-lg-5 {{ $errors->has('empresa') ? ' has-error' : '' }}">
                                    ...
                                    <select id="empresa" class="form-control empresa" data-placeholder="Selecione" name="empresa">
                                        @foreach( $empresa as $empresas )
                                            @if( $empresas->id == $cliente->empresa )
                                                <option value="{{ $empresas->id }}" selected>{{ $empresas->ds_empresa }}</option>
                                            @else
                                ...
                                <div class="form-group col-lg-2 {{ $errors->has('cep') ? ' has-error' : '' }}">
                                    ...
                                    <input id="cep" class="form-control" name="cep" required value="{{ $cliente->nr_cep }}"/>
                                    @if ($errors->has('cep'))
                                        <span class="help-block">
                                ...
                                <div class="form-group col-lg-2 {{ $errors->has('casa') ? ' has-error' : '' }}">
                                    ...
                                    <input id="nrcasa" class="form-control" name="casa" required value="{{ $cliente->nr_casa }}"/>
                                    @if ($errors->has('casa'))
                                        <span class="help-block">
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <input id="complemento" class="form-control" name="complemento" value="{{ $cliente->ds_complemento }}"/>
                                </div>
                                <div class="row"></div>
                                <div class="form-group col-lg-6">
                                    <label for="email">E-mail</label>
                                    <input type="email" id="email" class="form-control" name="email" required value="{{ $cliente->email }}"/>
                                </div>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <table class="table table-hover table-striped table-fone">
                                            ...
                                            <tbody class="tbodycad">

                                            @if( sizeof( $phone ) > 0 )
                                                @foreach( $phone as $phones )

                                                    <tr>
                                                        <td> <input name="telefone[]" value="{{ $phones->nr_fone }}"></td>
                                                        <td> <input name="obs[]" value="{{ $phones->obs_fone }}"></td>
                                                        <td> <input name="tipo[]" value="{{ $phones->tp_fone }}" size="1"></td>
                                                        <td> <input name="dstipo[]" value="{{ $phones->tp_fone == 'C' ? 'Celular' : 'Residencial' }}"></td>
